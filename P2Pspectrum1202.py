...
checkpoint = 1
if checkpoint:
    nnrho = torch.load('models/p2pRho{}_{}_{}'.format(args.Index,args.noise,args.epochs))
else:
    ...
    torch.save(nnrho, 'models/p2pRho{}_{}_{}'.format(args.Index,args.noise,args.epochs))
...
for epoch in range(args.epochs*40):  # loop over the dataset multiple times
    ...
    for i  in range(25):
        ...
        if (i % 25 == 24)&(epoch % 50 == 49) :    # print every 20 epoches
            print('[%d, %5d] chi2: %.8e lr: %.10f loss: %8f' % 

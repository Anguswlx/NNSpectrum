...
parser.add_argument('--l2', type=np.float32, default=1e-2, help='l2 regularization')
...
parser.add_argument('--maxiter', type=int, default=5000, help='Max epochs in training.')
